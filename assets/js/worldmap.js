...
$( function() {
  ...
  $('.worldmap-container #worldmap-div').bind('touchstart', function(e){
    ...
    initPosX = (e.touches[0].clientX-decalx);
    initPosY = (e.touches[0].clientY-decaly);
    ...
    if(isDrag){
      ...
      currentPosX = -(initPosX - e.touches[0].clientX);
      ...
      currentPosY = -(initPosY - e.touches[0].clientY);
